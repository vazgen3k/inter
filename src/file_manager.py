    ...
    async def fetch_file_by_uuid(self, uuid: str):
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code != 200:
                raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Invalid UUID4")
            ...
            return JSONResponse(content={"status": "success", "filename": filename}, status_code=200)
